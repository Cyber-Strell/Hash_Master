...
"""
__Author__ = 4NON STR3LL  
__Name__ = hasher
__version__ = 2.0 
__Code__ = python
__Github__ = https://github.com/Cyber-Strell
__Date__ = 21 - 4 - 2018
...
def info():
	...
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Version  "+C+":"+W+"  2.0  "+Y+"                               |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Author   "+C+":"+W+" Ci Ku "+R+"a.k.a "+W+"Xnver404"+Y+"       |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Email    "+C+":"+W+" pentest253@gmail.com"+Y+"                 |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Github   "+C+":"+W+" https://github.com/Cyber-Strell"+Y+"      |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Date     "+C+":"+W+" 23 - 02 - 2018"+Y+"                       |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Team     "+C+":"+W+" 4NON 4RMY"+Y+"                            |")
	print (Y+" 0{===================================================}0\n")
